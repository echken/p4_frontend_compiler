...
class Preprocessor(object):
	...
	#compound action internal dependency alysis and internal dependency decompose,construct new p4 program
        p4_code_list = p4_transformer(text.split('\n'), filename).p4_transform()
        text = '\n'.join(p4_code_list)
